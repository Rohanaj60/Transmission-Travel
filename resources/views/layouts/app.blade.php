    ...
    <div class="sidebar flex h-full md:grid grid-cols-5">
        <aside id="sidebar"
            ...
            {{-- <div class="logo-heading p-4 pb-0 ">
                <h1 class="text-orange text-3xl font-semibold">Travel-Card</h1>
            </div> --}}
            <div class="menu-links p-4 space-y-4 ">
                ...
                <div class="menu-2 space-y-2 ">
                    ...
                    <div class="sub-headlinks">
                        <Link href="{{ route('permissions.index') }}"
                            class=" {{ request()->routeIs('setting.index') ? 'text-white  bg-orange' : 'text-[#253949] hover:bg-[#F0F1F5]' }} block rounded-lg  p-4 w-full  font-sans  text-base font-semibold">
